...
useEffect(() => {
  ...
  return (
    <div className="App" style={{ 
      ...
      <img src={RoleIcon[taskData[22].id + '.png']} className='EvacCenterImg'  style={{left:'20.5%',bottom:'22.5%',transform: 'translate(-20.5%, 22.5%)', scale:'0.9',}} title={taskData[22].name}onClick={() => handleRoleClicked(taskData[22].name, 22)} tabIndex={0} />
      ...
      <img src={RoleIcon[taskData[24].id + '.png']} className='EvacCenterImg'  style={{left:'30.5%',bottom:'17.5%',transform: 'translate(-30.5%, 17.5%)',scale: '0.85'}} title={taskData[24].name}onClick={() => handleRoleClicked(taskData[24].name, 24)} tabIndex={0} />
      ...
      <img src={RoleIcon[taskData[11].id + '.png']} className='ExternalRoleImg' style={{left:'49.25%',bottom:'17%',transform: 'translate(-49.25%, 19%)', scale: '0.8'}} title={taskData[11].name}onClick={() => handleRoleClicked(taskData[11].name, 11)} tabIndex={0} />
      ...
      <img src={RoleIcon[taskData[27].id + '.png']} className='ExternalRoleImg' style={{left:'49.5%',bottom:'0.05%',transform: 'translate(-49.5%, 0.05%)', scale:'0.8'}} title={taskData[27].name}onClick={() => handleRoleClicked(taskData[27].name, 27)} tabIndex={0} />    
        </div>
      )}
