...
useEffect(() => {
  ...
  return (
    <div className="App" style={{ 
      ...
      <img src={RoleIcon[taskData[16].id + '.png']} className='EmergencyRoleImg'  style={{right:'22.5%',bottom:'15.5%',transform: 'translate(22.5%, 15.5%)',scale:'0.8'}} title={taskData[16].name}onClick={() => handleRoleClicked(taskData[16].name, 16)} tabIndex={0} />
      ...
      <img src={RoleIcon[taskData[22].id + '.png']} className='EvacCenterImg'  style={{left:'21%',bottom:'22%',transform: 'translate(-21%, 22%)', scale:'0.9',}} title={taskData[22].name}onClick={() => handleRoleClicked(taskData[22].name, 22)} tabIndex={0} />
      ...
      <img src={RoleIcon[taskData[24].id + '.png']} className='EvacCenterImg'  style={{left:'31.5%',bottom:'18%',transform: 'translate(-31.5%, 18%)',scale: '0.85'}} title={taskData[24].name}onClick={() => handleRoleClicked(taskData[24].name, 24)} tabIndex={0} />
      ...
      <img src={RoleIcon[taskData[11].id + '.png']} className='ExternalRoleImg' style={{left:'49.06%',bottom:'17%',transform: 'translate(-49.06%, 19%)',scale:'0.75'}} title={taskData[11].name}onClick={() => handleRoleClicked(taskData[11].name, 11)} tabIndex={0} />
      ...
      <img src={RoleIcon[taskData[26].id + '.png']} className='ExternalRoleImg' style={{right:'49.9%',bottom:'7.5%',transform: 'translate(49.9%, 7.5%)',scale:'0.95'}} title={taskData[26].name}onClick={() => handleRoleClicked(taskData[26].name, 26)} tabIndex={0} />
      ...
      <img src={RoleIcon[taskData[27].id + '.png']} className='ExternalRoleImg' style={{left:'49.25%',bottom:'0.1%',transform: 'translate(-49.25%, 0.1%)', scale:'0.85'}} title={taskData[27].name}onClick={() => handleRoleClicked(taskData[27].name, 27)} tabIndex={0} />    
        </div>
      )}
